...
/**
 * A Payload object which describes a single result returned by the Retrieve and
 * Rank Service. The service is provided with a user query, and returns a list
 * of 'hits' for the query. Each hit is called a 'document'. The document
 * contains various metadata which describes the data the service retrieved.
 */
