...
public class SetupThread extends Thread {
	...
	/**
	 * This method is used to update the JSON Config Object that will be sent
	 * back to the UI.
	 * 
	 * @param config
	 * @param setup_step
	 ...
	 * @param setup_phase
	 *            The current phase of the setup(this can be that the services
	 *            is being setup or if any other phase of the application is
	 *            being setup)
	 * @param setup_message
